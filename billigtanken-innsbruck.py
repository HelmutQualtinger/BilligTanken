...
# 0.06°×0.10°-Raster über Inntal-Korridor + Umland (Tirol, Vorarlberg Ost, Salzburg West)
LAT_MIN, LAT_MAX = 46.90, 47.70
LON_MIN, LON_MAX = 10.20, 13.00

QUERY_POINTS = [
    (round(lat, 3), round(lon, 3))
    for lat in [46.90 + i * 0.06 for i in range(int((47.70 - 46.90) / 0.06) + 1)]
    for lon in [10.20 + j * 0.10 for j in range(int((13.00 - 10.20) / 0.10) + 1)]
]
